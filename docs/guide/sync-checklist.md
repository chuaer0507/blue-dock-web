...
| ID         | 名称     | 规格                                            | 状态                                                                                                                                                                                                                                                                                                                                               |
| ---------- | -------- | ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| project    | 项目     | [project.md](../collaboration/project.md)       | wip（设置/置顶/侧栏拖拽排序/看板拖拽含 TASK_MOVE+LIST_SORT 门控/列管理细粒度 TASK_LIST_*/column/one hook/成员含邀请链接/权限含 TASK_ADD·STATUS·ARCHIVED 批量与工作流拖/收藏/搜索筛选/归档列表/动态/CSV导出/工作流配置/项目标签；部门只读·归档禁编）                                                                                                |
| task       | 任务     | [task.md](../collaboration/task.md)             | wip（详情含权限门控 UPDATE/TIME/STATUS/REMOVE/ARCHIVED/MOVE/ADD/Modal/快建 CreateTaskQuick 含 TASK_ADD/优先级颜色可见性勾选/负责人协助/关联搜索/子任务升级/跨项目移动/软删/附件下载删/模板默认删除排序跨项目搜/看板头像/DatePicker/收藏/讨论/流转/标签/子任务/动态含 resetFromLog/快建含模板/复制/发送到会话/循环/内容历史/AI/计划冲突 easyLists） |
| view       | 视图     | [view.md](../collaboration/view.md)             | wip（看板/列表/甘特/工作流含标签与负责人 + 列标题拖拽排序 + 配置编辑 + 搜索筛选 + 批量完成/归档/换列 + 每项目偏好）                                                                                                                                                                                                                                |
